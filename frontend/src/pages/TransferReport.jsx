          ...
          {summaries.map(s => (
            <div key={s.deposit_name} className="bg-white rounded-xl shadow-sm p-4">
              ...
              <div className="space-y-1 text-sm">
                <div className="flex justify-between"><span className="text-blue-600">Abastecimento</span><span className="font-medium">{s.abastecimento_qty}</span></div>
          ...
          <tbody>
            {report.map((r, i) => (
              <tr key={`${r.deposit_id}-${r.product_id}-${i}`} className="border-t hover:bg-gray-50">
                ...
                <td className="p-3 text-center text-blue-600 font-medium">{r.abastecimento_qty}</td>
